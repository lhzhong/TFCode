...
retrain_model_dir = './model/KTH_RGB_retrain/'
logs_train_dir = './logs/KTH_RGB_retrain/'
logs_val_dir = './logs/KTH_RGB_reval/'
train_txt = 'train.txt'
val_txt = 'val.txt'
        ...
        try:
            for step in np.arange(MAX_STEP):
                ...
                if step % 2000 == 0 or (step + 1) == MAX_STEP:
                    checkpoint_path = os.path.join(retrain_model_dir, 'model.ckpt')
